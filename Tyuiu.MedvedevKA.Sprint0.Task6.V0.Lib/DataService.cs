...
namespace Tyuiu.MedvedevKA.Sprint0.Task6.V0.Lib
{
    public class DataService
    {
        ...
        //Пример циклической структуры (цикл с предусловием) white
        ...
        //Пример циклической структуры (цикл с постусловием) do white
